...
def main():
    ...
    with tf.Session() as sess:
        ...
        save_images(pos_relu_X[:, 0:pos_relu_X.shape[1] - 1], train_fn, os.path.join(viz_path, "pos_relu"))
        save_images(neg_relu_X[:, 0:neg_relu_X.shape[1] - 1], train_fn, os.path.join(viz_path, "neg_relu"))
        save_images(all_pass_X[:, 0:all_pass_X.shape[1] - 1], train_fn, os.path.join(viz_path, "all_pass"))
